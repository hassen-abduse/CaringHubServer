...
app.use('/volImageUpload', uploads.volImageUpload)
app.use('/orgLogoUpload', uploads.orgLogoUpload)
app.use('/userImageUpload', uploads.userImageUpload)
app.use('/projectImageUpload', uploads.projectImageUpload)
